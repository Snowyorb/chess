...
function kb(a){var b=V(a.a);$("#moves").html('<div class="undoHolder"><a href="#" id="undo" class="'+(a.a.i.length?"can":"cannot")+'">undo</a></div><br/><div class="autoHolder"><a href="#" id="auto" class="'+(0<b.length?"can":"cannot")+'">auto</a></div><br/><h5>Possible Moves</h5>'+b.map(function(d,e){return'<div class="aHolder"><a href="#" class="tag" id="'+e+'">'+(Ja(d)?"0-0"+(3===P(d)?"-0":""):" NBRQK".charAt(R(d))+f(O(d))+(P(d)&4?"x":"-")+f(d.value&63)+(5===P(d)?"e.p.":"")+(P(d)&8?" NBRQK".charAt(P(d)&
8?1+(P(d)&3):0):""))+"</a></div><br/>"}).join(""));$("#chessboard table tr td, #chessboard table tr td div").removeClass("can-move");b.forEach(function(d){d=$("#"+f(O(d)));d.add(d.children()).addClass("can-move")});var c=!1;$("#chessboard table tr td div.can-move").mouseenter(function(){if(!c){var d=$(this),e=d.parent(),h=ca(""+e.attr("id"));e=e.add(d);e.toggleClass("from",b.some(function(k){return O(k)===h}));e.hasClass("from")&&(b.forEach(function(k){if(O(k)===h){var n=$("#"+f(k.value&63));n=n.add(n.children());
n.addClass("to");n.addClass(0===P(k)?"positional":"");n.addClass(P(k)&4?"capture":"");n.addClass(1===P(k)?"double-push":"");n.addClass(5===P(k)?"en-passant":"");n.addClass(P(k)&8?"promotion":"");n.addClass(Ja(k)?"castle":"");n.addClass(2===P(k)?"king-castle":"");n.addClass(3===P(k)?"queen-castle":"")}}),jb(),$("#chessboard table tr td.to").droppable({drop:function(){var k=ca(""+$(this).attr("id")),n=b.filter(function(r){return O(r)===h&&(r.value&63)===k});0<n.length?(Z(a.a,n[0]),lb(a)):(ib(),jb())}}),
d.draggable({start:function(){c=!0},stop:function(){c=!1},containment:"#chessboard table",zIndex:10,revert:"invalid"}))}}).mouseleave(function(){c||ib()});$("#moves a").click(function(){var d=$(this).attr("id");"undo"===d?($a(a.a),$a(a.a),lb(a)):"auto"===d?mb(a):(Z(a.a,b[parseInt(d,10)]),lb(a))})}
